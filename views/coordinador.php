                        ...
                        <ul class="nav flex-column sidebar-nav">
                            <li class="nav-item">
                                <a class="nav-link sidebar-option active" href="#" data-page="carga_periodo.php">
                                    <i class="bi bi-calendar-event me-2"></i>Carga Período
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link sidebar-option" href="#" data-page="historial_estudiantes.php">
                                    <i class="bi bi-mortarboard me-2"></i>Historial Estudiantes
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link sidebar-option" href="#" data-page="cambios_carrera.php">
                                    <i class="bi bi-arrow-left-right me-2"></i>Cambios de Carrera
                                </a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link sidebar-option" href="#" data-page="cambios_centro.php">
                                    <i class="bi bi-building me-2"></i>Cambios de Centro
                                </a>
                            </li>
                            <li class="nav-item">
