...
<head>
    ...
    <title>Biblioteca Virtual Universitaria - Panel Docente</title>
    <!-- Bootstrap CSS -->
        ...
        <div class="container-fluid px-3">
            <div class="d-flex align-items-center">
                ...
                <div class="d-flex align-items-center me-3">
                    ...
                    <span class="fs-4 fw-bold">UNAH Biblioteca - Docente</span>
                </div>
                ...
                <!-- Iconos de acción -->
                <div class="d-flex align-items-center">
                    <button class="btn btn-success me-2" id="btn-agregar-libro">
                    ...
                    <form id="form-libro">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="tags-input-container" id="autores-container">
                                <input type="text" id="input-autor" placeholder="Escribe un autor y presiona Enter">
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="tags-input-container" id="tags-container">
                                <input type="text" id="input-tag" placeholder="Escribe una categoría y presiona Enter">
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <label for="portada" class="file-input-label" id="file-input-label">
                                <img id="previewPortada" src="" alt="Vista previa de la portada">
